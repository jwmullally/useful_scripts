...
CLUSTER_UP="oc cluster up --host-data-dir=/var/lib/origin/openshift.local.etcd --public-hostname=master.test --routing-suffix=cluster.test $EXTRA_OPTIONS"
CALLER=`logname`
...
host-record=master.test,172.17.0.1
address=/cluster.test/172.17.0.1
